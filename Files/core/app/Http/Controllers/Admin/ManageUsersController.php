...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $bookedTour = PlanLog::where('status', Status::TOUR_COMPLETED)->where('type', 'tour')->where('user_id', $user->id)->count();
        $bookedSeminar = PlanLog::where('status', Status::TOUR_COMPLETED)->where('type', 'seminar')->where('user_id', $user->id)->count();
        $countries = json_decode(file_get_contents(resource_path('views/partials/country.json')));
        return view('admin.users.detail', compact('pageTitle', 'user', 'totalDeposit', 'bookedTour', 'bookedSeminar', 'countries'));
    }
